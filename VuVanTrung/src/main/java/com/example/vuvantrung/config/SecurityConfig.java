    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers("/TierConfig/**").hasRole("ADMIN")
                        .requestMatchers("/UsageHistory/user/{id}").hasRole("USER")
                        .requestMatchers("/api/users/user-usage-history/{userId}").hasRole("USER")
                        .requestMatchers("/UsageHistory/create_usage_history_by_admin").hasRole("ADMIN")
                        .anyRequest().authenticated()
                )
